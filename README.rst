...
DCOM LAB example (use proxy for all the existing YUM repositories, distribute ca_certificates)
...
.. code-block:: yaml
    ...
    linux:
      system:
        ...
        ca_certificates:
          - ^intra.dcom.sk*          # regexp are supported
          - ^common*
        user:
          tomcat:
            name: 'tomcat'
        ...
        repo:
          epel:
            enabled: true
            source: 'https://ftp.upjs.sk/pub/mirrors/epel/6/x86_64/'
            pgpcheck: 0
        package:
          mc:
            version: latest
      ...
      network:
        enabled: true
        hostname: sp2salt01.intra.dcom.sk
        resolv:
          dns:
          - 10.231.160.11
          - 10.231.160.12
        ...
        host:
          node1:
            address: 10.236.61.99
            names:
            - sp2salt01.intra.dcom.sk
            - sp2salt01
          node2:
            address: 10.236.61.21
            names:
            - sp2atjb01.intra.dcom.sk
            - sp2atjb01
          node3:
            address: 172.16.13.78
            names:
            - git.posam.sk

Use proxy only for the selected YUM repository (RedHat family OS)
...
.. code-block:: yaml
  ...
  linux:
    system:
      sudo:
        enabled: true
        # requiretty set to false means that remote sudo execution will be allowed!!! default value is usually set tu TRUE!!
        requiretty: false
        alias:
          host:
            LOCAL:
